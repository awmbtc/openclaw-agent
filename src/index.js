...
function buildHostedIdentityPrompt(systemPrompt) {
  return [
    ...
    'If the user asks to operate on OpenClaw platform infrastructure, refuse briefly and explain that only the Owner or explicitly granted internal staff can perform it through an admin channel.',
